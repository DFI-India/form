...
export function Sidebar({ role }: SidebarProps) {
  ...
  const menuItems: Record<UserRole, { label: string; href: string; icon: string }[]> = {
    field_volunteer: [
      ...
      { label: 'Submit Report', href: '/field-volunteer/submit-report', icon: '📝' },
    ...
    dfi_field_staff: [
      ...
      { label: 'Review Data', href: '/dfi-field-staff/review', icon: '🔍' },
      { label: 'Verify Records', href: '/dfi-field-staff/verify', icon: '✔️' },
      { label: 'My Updates', href: '/dfi-field-staff/updates', icon: '📝' },
    ...
    dfi_staff: [
      ...
      { label: 'Edit Records', href: '/dfi-staff/edit', icon: '✏️' },
      { label: 'Approvals', href: '/dfi-staff/approvals', icon: '✅' },
      { label: 'Analytics', href: '/dfi-staff/analytics', icon: '📈' },
    ...
    tech_support: [
      ...
      { label: 'Support Tickets', href: '/tech-support/tickets', icon: '🎫' },
      { label: 'Database', href: '/tech-support/database', icon: '🗄️' },
      { label: 'Logs', href: '/tech-support/logs', icon: '📝' },
      { label: 'Settings', href: '/tech-support/settings', icon: '⚙️' },
    ],
  }
